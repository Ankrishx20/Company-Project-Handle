...
public class Dev_show_modules extends javax.swing.JFrame {
    ...
    PreparedStatement ps=null;
        ...
        public Dev_show_modules() {
        initComponents();
            showid(Developer.devnn);
    }
    ...
    private void initComponents() {
        ...
        emp_id.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        emp_id.setForeground(new java.awt.Color(255, 255, 255));
        emp_id.setText("HJello");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(emp_id, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(188, 188, 188))
        );
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 660, 980, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Remove_client.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dev_show_modules().setVisible(true);
            }
        });
    }
    
     
    void showid(String demail)
    {
       id="emp_id";
       try
        {
            ...
            PreparedStatement stmt=con.prepareStatement("select emp_id from emp_info where emp_email=?");
            stmt.setString(1,demail);
            ResultSet rs=stmt.executeQuery();
              
            if(rs.next())
            {
                emp_id.setText(rs.getString(id));
            }
            
            empnn=emp_id.getText();
    ...
    void showmodules(String empnn)
    {
            try
            { 
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/comp_project","root","ankrish123");
            PreparedStatement ps=con.prepareStatement("select m_id,m_name,manager_id,p_id,mdeadline,m_comp_date from module where emp_id=?");
            ps.setString(1,empnn);
