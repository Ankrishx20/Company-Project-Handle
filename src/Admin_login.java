...
public class Admin_login extends javax.swing.JFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private boolean validate_login(String aemail, String apass) {
			try
			{
				Class.forName("com.mysql.jdbc.Driver");
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/comp_project","root","ankrish123");
				PreparedStatement stmt=con.prepareStatement("select admin_email, admin_pass from admin_info where admin_email=? and admin_pass=?");
