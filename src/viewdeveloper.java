...
public class viewdeveloper extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(978, 637));
        setMinimumSize(new java.awt.Dimension(978, 637));
        setPreferredSize(new java.awt.Dimension(978, 637));
        setResizable(false);
        setSize(new java.awt.Dimension(978, 637));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 540, 980, 100));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewmodules().setVisible(true);
            }
        });
    }
