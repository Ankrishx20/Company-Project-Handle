...
public class Remove_client extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(client_id, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(31, 31, 31)
	...
	{	
            int dialog=JOptionPane.showConfirmDialog(null,"Do you really want to delete this Client","Delete",JOptionPane.YES_NO_OPTION);
            if(dialog==0)
            {
            PreparedStatement stmt=con.prepareStatement("delete from client where c_id=?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Remove_client().setVisible(true);
            }
        });
    }
